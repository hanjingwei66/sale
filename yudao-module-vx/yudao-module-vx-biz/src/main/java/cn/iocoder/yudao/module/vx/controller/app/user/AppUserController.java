package cn.iocoder.yudao.module.vx.controller.app.user;
...
public class AppUserController {
    ...
    @GetMapping("/getSinUpList")
    @ApiOperation("用户报名列表")
    public CommonResult<PageResult<ShiyaoProjectRespVO>> getSignUpProjectList(ShiyaoProjectPageReqVO userId) throws Exception {

        return success(vxUserProjectService.getSignUpProjectList(userId));
    }
}
