package cn.iocoder.yudao.module.vx.controller.admin.helpinfo;
...
import cn.iocoder.yudao.module.vx.controller.admin.helpinfo.vo.*;
...
public class HelpInfoController {
    ...
    @PostMapping("/create")
    @ApiOperation("创建帮助信息")
    @PreAuthorize("@ss.hasPermission('vx:help-info:create')")
    ...
    @PutMapping("/update")
    @ApiOperation("更新帮助信息")
    @PreAuthorize("@ss.hasPermission('vx:help-info:update')")
    ...
    @PreAuthorize("@ss.hasPermission('vx:help-info:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('vx:help-info:query')")
    ...
    @PreAuthorize("@ss.hasPermission('vx:help-info:export')")
