package cn.iocoder.yudao.module.vx.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode GROUP_NOT_EXISTS = new ErrorCode(1002022090, "用户组不存在");
    ErrorCode PROJECT_NOT_EXISTS = new ErrorCode(1002022091, "试药项目不存在");
    ErrorCode SHIYAO_PROJECT_NOT_EXISTS = new ErrorCode(1002022092, "试药项目不存在");
    ErrorCode VX_USER_NOT_EXISTS = new ErrorCode(1002022093, "微信用户信息不存在");
    ErrorCode NOTICE_NOT_EXISTS = new ErrorCode(1002022094, "公告栏不存在");
    ErrorCode HELP_INFO_NOT_EXISTS = new ErrorCode(1002022095, "帮助信息不存在");
}
