package cn.iocoder.yudao.module.hq.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode CUSTOMER_NOT_EXISTS = new ErrorCode(1002022091, "hq用户不存在");
    ErrorCode QUOTA_NOT_EXISTS = new ErrorCode(1002022092, "指标不存在");}
